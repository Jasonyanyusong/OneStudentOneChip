...
void Vregister64___024root__traceChgSub0(Vregister64___024root* vlSelf, VerilatedVcd* tracep);
...
void Vregister64___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        Vregister64___024root__traceChgSub0((&vlSymsp->TOP), tracep);
    }
}
...
void Vregister64___024root__traceChgSub0(Vregister64___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgQData(oldp+3,(vlSelf->inp),64);
        tracep->chgQData(oldp+5,(vlSelf->q),64);
    }
}

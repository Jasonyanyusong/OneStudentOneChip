...
void Vregister1___024root__traceChgSub0(Vregister1___024root* vlSelf, VerilatedVcd* tracep);
...
void Vregister1___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        Vregister1___024root__traceChgSub0((&vlSymsp->TOP), tracep);
    }
}
...
void Vregister1___024root__traceChgSub0(Vregister1___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgBit(oldp+3,(vlSelf->inp));
        tracep->chgBit(oldp+4,(vlSelf->q));
    }
}

...
#include <iostream>
#include "./obj_dir/VCyclicLeftShiftRegister_PosEdge_2Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VCyclicLeftShiftRegister_PosEdge_2Bit* top;
...
void sim_init()
{
	...
	top = new VCyclicLeftShiftRegister_PosEdge_2Bit;
...
int main()
{
	...
	printf("This is a CyclicLeftShiftRegister_PosEdge_2Bit\n");
	sim_init();

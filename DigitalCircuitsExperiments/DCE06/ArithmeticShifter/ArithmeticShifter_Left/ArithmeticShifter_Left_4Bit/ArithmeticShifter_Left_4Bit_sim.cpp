...
#include <iostream>
#include "./obj_dir/VArithmeticShifter_Left_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VArithmeticShifter_Left_4Bit* top;
...
void sim_init()
{
	...
	top = new VArithmeticShifter_Left_4Bit;
...
int main()
{
	...
	printf("This is a ArithmeticShifter_Left_4Bit\n");
	sim_init();

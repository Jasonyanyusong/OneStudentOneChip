...
#include <iostream>
#include "./obj_dir/VArithmeticShifter_Right_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VArithmeticShifter_Right_4Bit* top;
...
void sim_init()
{
	...
	top = new VArithmeticShifter_Right_4Bit;
...
int main()
{
	...
	printf("This is a ArithmeticShifter_Right_4Bit\n");
	sim_init();

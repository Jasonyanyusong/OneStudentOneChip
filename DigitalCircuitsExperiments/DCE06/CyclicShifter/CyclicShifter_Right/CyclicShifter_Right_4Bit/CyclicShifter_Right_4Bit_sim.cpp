...
#include <iostream>
#include "./obj_dir/VCyclicShifter_Right_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VCyclicShifter_Right_4Bit* top;
...
void sim_init()
{
	...
	top = new VCyclicShifter_Right_4Bit;
...
int main()
{
	...
	printf("This is a CyclicShifter_Right_4Bit\n");
	sim_init();

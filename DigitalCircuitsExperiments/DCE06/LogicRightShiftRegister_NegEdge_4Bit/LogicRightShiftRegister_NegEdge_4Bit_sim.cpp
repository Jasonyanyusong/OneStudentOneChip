...
#include <iostream>
#include "./obj_dir/VLogicRightShiftRegister_NegEdge_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VLogicRightShiftRegister_NegEdge_4Bit* top;
...
void sim_init()
{
	...
	top = new VLogicRightShiftRegister_NegEdge_4Bit;
...
int main()
{
	...
	printf("This is a LogicRightShiftRegister_NegEdge_4Bit\n");
	sim_init();

...
#include <iostream>
#include "./obj_dir/VArithmeticRightShiftRegister_NegEdge_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VArithmeticRightShiftRegister_NegEdge_4Bit* top;
...
void sim_init()
{
	...
	top = new VArithmeticRightShiftRegister_NegEdge_4Bit;
...
int main()
{
	...
	printf("This is a ArithmeticRightShiftRegister_NegEdge_4Bit\n");
	sim_init();

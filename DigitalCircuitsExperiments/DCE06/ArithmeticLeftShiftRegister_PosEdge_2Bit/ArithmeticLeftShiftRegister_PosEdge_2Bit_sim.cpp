...
#include <iostream>
#include "./obj_dir/VArithmeticLeftShiftRegister_PosEdge_2Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VArithmeticLeftShiftRegister_PosEdge_2Bit* top;
...
void sim_init()
{
	...
	top = new VArithmeticLeftShiftRegister_PosEdge_2Bit;
...
int main()
{
	...
	printf("This is a ArithmeticLeftShiftRegister_PosEdge_2Bit\n");
	sim_init();

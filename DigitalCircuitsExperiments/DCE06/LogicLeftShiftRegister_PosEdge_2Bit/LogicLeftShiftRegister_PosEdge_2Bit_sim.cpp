...
#include <iostream>
#include "./obj_dir/VLogicLeftShiftRegister_PosEdge_2Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VLogicLeftShiftRegister_PosEdge_2Bit* top;
...
void sim_init()
{
	...
	top = new VLogicLeftShiftRegister_PosEdge_2Bit;
...
int main()
{
	...
	printf("This is a LogicLeftShiftRegister_PosEdge_2Bit\n");
	sim_init();

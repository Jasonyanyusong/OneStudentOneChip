...
#include <iostream>
#include "./obj_dir/VArithmeticLeftShiftRegister_NegEdge_2Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VArithmeticLeftShiftRegister_NegEdge_2Bit* top;
...
void sim_init()
{
	...
	top = new VArithmeticLeftShiftRegister_NegEdge_2Bit;
...
int main()
{
	...
	printf("This is a ArithmeticLeftShiftRegister_NegEdge_2Bit\n");
	sim_init();

...
#include <iostream>
#include "./obj_dir/VCyclicRightShiftRegister_NegEdge_2Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VCyclicRightShiftRegister_NegEdge_2Bit* top;
...
void sim_init()
{
	...
	top = new VCyclicRightShiftRegister_NegEdge_2Bit;
...
int main()
{
	...
	printf("This is a CyclicRightShiftRegister_NegEdge_2Bit\n");
	sim_init();

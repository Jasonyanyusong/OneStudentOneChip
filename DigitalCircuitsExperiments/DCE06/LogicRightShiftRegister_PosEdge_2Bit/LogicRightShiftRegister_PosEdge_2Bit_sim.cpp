...
#include <iostream>
#include "./obj_dir/VLogicRightShiftRegister_PosEdge_2Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VLogicRightShiftRegister_PosEdge_2Bit* top;
...
void sim_init()
{
	...
	top = new VLogicRightShiftRegister_PosEdge_2Bit;
...
int main()
{
	...
	printf("This is a LogicRightShiftRegister_PosEdge_2Bit\n");
	sim_init();

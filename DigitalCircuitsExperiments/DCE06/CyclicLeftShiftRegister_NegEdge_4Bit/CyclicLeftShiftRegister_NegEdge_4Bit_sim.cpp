...
#include <iostream>
#include "./obj_dir/VCyclicLeftShiftRegister_NegEdge_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VCyclicLeftShiftRegister_NegEdge_4Bit* top;
...
void sim_init()
{
	...
	top = new VCyclicLeftShiftRegister_NegEdge_4Bit;
...
int main()
{
	...
	printf("This is a CyclicLeftShiftRegister_NegEdge_4Bit\n");
	sim_init();

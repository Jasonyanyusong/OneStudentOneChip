...
#include <iostream>
#include "./obj_dir/VLogicRightShiftRegister_PosEdge_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VLogicRightShiftRegister_PosEdge_4Bit* top;
...
void sim_init()
{
	...
	top = new VLogicRightShiftRegister_PosEdge_4Bit;
...
int main()
{
	...
	printf("This is a LogicRightShiftRegister_PosEdge_4Bit\n");
	sim_init();

...
#include <iostream>
#include "./obj_dir/VCyclicRightShiftRegister_NegEdge_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VCyclicRightShiftRegister_NegEdge_4Bit* top;
...
void sim_init()
{
	...
	top = new VCyclicRightShiftRegister_NegEdge_4Bit;
...
int main()
{
	...
	printf("This is a CyclicRightShiftRegister_NegEdge_4Bit\n");
	sim_init();

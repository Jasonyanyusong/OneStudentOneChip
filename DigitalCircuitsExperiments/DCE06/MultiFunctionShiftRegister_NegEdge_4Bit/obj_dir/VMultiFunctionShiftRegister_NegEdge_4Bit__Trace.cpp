...
void VMultiFunctionShiftRegister_NegEdge_4Bit___024root__traceChgSub0(VMultiFunctionShiftRegister_NegEdge_4Bit___024root* vlSelf, VerilatedVcd* tracep);
...
void VMultiFunctionShiftRegister_NegEdge_4Bit___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        VMultiFunctionShiftRegister_NegEdge_4Bit___024root__traceChgSub0((&vlSymsp->TOP), tracep);
    }
}
...
void VMultiFunctionShiftRegister_NegEdge_4Bit___024root__traceChgSub0(VMultiFunctionShiftRegister_NegEdge_4Bit___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgCData(oldp+3,(vlSelf->D),4);

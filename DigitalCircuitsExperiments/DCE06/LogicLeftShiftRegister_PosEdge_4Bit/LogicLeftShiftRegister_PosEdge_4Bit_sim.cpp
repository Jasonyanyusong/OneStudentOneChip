...
#include <iostream>
#include "./obj_dir/VLogicLeftShiftRegister_PosEdge_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VLogicLeftShiftRegister_PosEdge_4Bit* top;
...
void sim_init()
{
	...
	top = new VLogicLeftShiftRegister_PosEdge_4Bit;
...
int main()
{
	...
	printf("This is a LogicLeftShiftRegister_PosEdge_4Bit\n");
	sim_init();

...
#include <iostream>
#include "./obj_dir/VLogicLeftShiftRegister_NegEdge_4Bit.h"

VerilatedContext* contextp = NULL;
VerilatedVcdC* tfp = NULL;

static VLogicLeftShiftRegister_NegEdge_4Bit* top;
...
void sim_init()
{
	...
	top = new VLogicLeftShiftRegister_NegEdge_4Bit;
...
int main()
{
	...
	printf("This is a LogicLeftShiftRegister_NegEdge_4Bit\n");
	sim_init();

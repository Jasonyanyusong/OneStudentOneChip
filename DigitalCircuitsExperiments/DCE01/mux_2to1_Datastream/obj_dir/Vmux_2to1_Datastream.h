...
class Vmux_2to1_Datastream VL_NOT_FINAL {
  private:
    ...
    Vmux_2to1_Datastream__Syms* const vlSymsp;
  ...
  public:
    ...
    Vmux_2to1_Datastream___024root* const rootp;
    ...
    explicit Vmux_2to1_Datastream(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vmux_2to1_Datastream(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vmux_2to1_Datastream();
  private:

...
void Vbcd7seg_case_coPositive___024root__trace_chg_sub_0(Vbcd7seg_case_coPositive___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vbcd7seg_case_coPositive___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbcd7seg_case_coPositive___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vbcd7seg_case_coPositive___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vbcd7seg_case_coPositive___024root__trace_chg_sub_0(Vbcd7seg_case_coPositive___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vbcd7seg_case_coPositive__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbcd7seg_case_coPositive___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vbcd7seg_case_coPositive___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbcd7seg_case_coPositive___024root__trace_cleanup\n"); );
    // Init
    Vbcd7seg_case_coPositive___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vbcd7seg_case_coPositive___024root*>(voidSelf);
    Vbcd7seg_case_coPositive__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;

...
void Vdecode_3to8_for___024root__trace_chg_sub_0(Vdecode_3to8_for___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vdecode_3to8_for___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode_3to8_for___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vdecode_3to8_for___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vdecode_3to8_for___024root__trace_chg_sub_0(Vdecode_3to8_for___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vdecode_3to8_for__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode_3to8_for___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+3,(vlSelf->decode_3to8_for__DOT__i),32);
}

void Vdecode_3to8_for___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode_3to8_for___024root__trace_cleanup\n"); );
    // Init
    Vdecode_3to8_for___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vdecode_3to8_for___024root*>(voidSelf);
    Vdecode_3to8_for__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;

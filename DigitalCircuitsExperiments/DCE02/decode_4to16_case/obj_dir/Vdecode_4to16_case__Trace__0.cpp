...
void Vdecode_4to16_case___024root__trace_chg_sub_0(Vdecode_4to16_case___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vdecode_4to16_case___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode_4to16_case___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vdecode_4to16_case___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vdecode_4to16_case___024root__trace_chg_sub_0(Vdecode_4to16_case___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vdecode_4to16_case__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode_4to16_case___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vdecode_4to16_case___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode_4to16_case___024root__trace_cleanup\n"); );
    // Init
    Vdecode_4to16_case___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vdecode_4to16_case___024root*>(voidSelf);
    Vdecode_4to16_case__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;

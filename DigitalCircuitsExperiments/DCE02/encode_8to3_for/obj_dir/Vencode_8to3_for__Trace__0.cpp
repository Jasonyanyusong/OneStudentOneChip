...
void Vencode_8to3_for___024root__trace_chg_sub_0(Vencode_8to3_for___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vencode_8to3_for___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode_8to3_for___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vencode_8to3_for___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vencode_8to3_for___024root__trace_chg_sub_0(Vencode_8to3_for___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vencode_8to3_for__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode_8to3_for___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+3,(vlSelf->encode_8to3_for__DOT__i),32);
}

void Vencode_8to3_for___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode_8to3_for___024root__trace_cleanup\n"); );
    // Init
    Vencode_8to3_for___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vencode_8to3_for___024root*>(voidSelf);
    Vencode_8to3_for__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;

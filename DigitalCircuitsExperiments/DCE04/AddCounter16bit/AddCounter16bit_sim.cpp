...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/AddCounter16bit/obj_dir/VAddCounter16bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 16bit Add-Counter modeled by datastream");
    printf("\n");

...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/AddCounter/test_posedge_sim_c/obj_dir/VAddCounter.h"
...
int main()
{
    ...
    top -> en = 1; top -> clk = 01; step_and_dump_wave();
    top -> en = 1; top -> clk = 01; step_and_dump_wave();
    top -> en = 1; top -> clk = 01; step_and_dump_wave();
    top -> en = 1; top -> clk = 01; step_and_dump_wave();
    top -> en = 1; top -> clk = 01; step_and_dump_wave();
    ...
    top -> en = 0; top -> clk = 01; step_and_dump_wave();
    top -> en = 0; top -> clk = 01; step_and_dump_wave();
    top -> en = 0; top -> clk = 01; step_and_dump_wave();
    top -> en = 0; top -> clk = 01; step_and_dump_wave();
    top -> en = 0; top -> clk = 01; step_and_dump_wave();

...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/SubCounter1bit/obj_dir/VSubCounter1bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 1bit Sub-Counter modeled by datastream");
    printf("\n");

...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/AddCounter8bit/obj_dir/VAddCounter8bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 8bit Add-Counter modeled by datastream");
    printf("\n");

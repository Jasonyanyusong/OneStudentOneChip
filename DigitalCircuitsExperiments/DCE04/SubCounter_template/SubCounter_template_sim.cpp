...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/SubCounterXbit/obj_dir/VSubCounterXbit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a Xbit Sub-Counter modeled by datastream");
    printf("\n");

...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/AddCounter32bit/obj_dir/VAddCounter32bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 32bit Add-Counter modeled by datastream");
    printf("\n");

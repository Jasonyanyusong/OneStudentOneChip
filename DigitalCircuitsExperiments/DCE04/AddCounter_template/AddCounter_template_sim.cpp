...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/AddCounterXbit/obj_dir/VAddCounterXbit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a Xbit Add-Counter modeled by datastream");
    printf("\n");

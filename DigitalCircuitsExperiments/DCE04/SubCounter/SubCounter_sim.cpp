...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/SubCounter/obj_dir/VSubCounter.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 3-bit SubCounter modeled by datastream");
    printf("\n");

...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/AddCounter1bit/obj_dir/VAddCounter1bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 1bit Add-Counter modeled by datastream");
    printf("\n");

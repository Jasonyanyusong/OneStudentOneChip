...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/AddCounter2bit/obj_dir/VAddCounter2bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 2bit Add-Counter modeled by datastream");
    printf("\n");

...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/SubCounter4bit/obj_dir/VSubCounter4bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 4bit Sub-Counter modeled by datastream");
    printf("\n");

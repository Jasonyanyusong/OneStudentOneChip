...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/SubCounter2bit/obj_dir/VSubCounter2bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 2bit Sub-Counter modeled by datastream");
    printf("\n");

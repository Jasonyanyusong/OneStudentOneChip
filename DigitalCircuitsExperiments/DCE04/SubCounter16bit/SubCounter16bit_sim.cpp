...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/SubCounter16bit/obj_dir/VSubCounter16bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 16bit Sub-Counter modeled by datastream");
    printf("\n");

...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE04/AddCounter4bit/obj_dir/VAddCounter4bit.h"
...
int main()
{
    ...
    printf("\n");
    printf("This is a 4bit Add-Counter modeled by datastream");
    printf("\n");

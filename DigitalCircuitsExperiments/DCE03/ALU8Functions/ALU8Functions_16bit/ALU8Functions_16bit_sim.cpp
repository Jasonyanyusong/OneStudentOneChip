...
#include "/home/yanyusong/OneStudentOneChip/DigitalCircuitsExperiments/DCE03/ALU8Functions/ALU8Functions_16bit/obj_dir/VALU8Functions_16bit.h"
...
static VALU8Functions_16bit* top;
...
int main()
{
    ...
    printf("\n");
    printf("This is a 16-bit 8-functions-ALU modeled by datastream");
    printf("\n");
    ...
    {
        for(int j = 0b0000000000000000; j <= 0b1111111111111111; j += 0b100000)
        {
            for(int k = 0b0000000000000000; k <= 0b1111111111111111; k += 0b100000)
            {

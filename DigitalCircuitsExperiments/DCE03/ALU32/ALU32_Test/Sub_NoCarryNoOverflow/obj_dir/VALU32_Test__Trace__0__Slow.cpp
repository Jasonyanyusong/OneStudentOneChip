...
VL_ATTR_COLD void VALU32_Test___024root__trace_init_sub__TOP__0(VALU32_Test___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+9,"testF2S1B1T1_expected_result", false,-1, 31,0);
    ...
    tracep->declBus(c+11,"testF2S1B2T1_expected_result", false,-1, 31,0);
    ...
    tracep->declBus(c+12,"testF2S1B2T2_expected_result", false,-1, 31,0);
    tracep->declBus(c+10,"testF2S1B2T2_expected_carry", false,-1, 0,0);
    tracep->declBit(c+13,"testF2S1B1T2_expected_zero", false,-1);
    tracep->declBit(c+14,"testF2S1B1T2_expected_overflow", false,-1);
    tracep->declBit(c+10,"testF2S1B2T2_expected_overflow", false,-1);
    tracep->declBit(c+10,"testF2S1B2T2_expected_zero", false,-1);
    tracep->declBus(c+15,"testF2S1B2T3_expected_result", false,-1, 31,0);
    tracep->declBus(c+10,"testF2S1B2T3_expected_carry", false,-1, 0,0);
    tracep->declBit(c+16,"testF2S1B1T3_expected_zero", false,-1);
    tracep->declBit(c+17,"testF2S1B1T3_expected_overflow", false,-1);
    tracep->declBit(c+10,"testF2S1B2T3_expected_overflow", false,-1);
    tracep->declBit(c+10,"testF2S1B2T3_expected_zero", false,-1);
    tracep->declBus(c+15,"testF2S1B3T1_expected_result", false,-1, 31,0);
    ...
    tracep->declBus(c+12,"testF2S1B3T2_expected_result", false,-1, 31,0);
    ...
    tracep->declBus(c+11,"testF2S1B3T3_expected_result", false,-1, 31,0);
...
VL_ATTR_COLD void VALU32_Test___024root__trace_full_sub_0(VALU32_Test___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+9,(0x423a35c6U),32);
    bufp->fullBit(oldp+10,(0U));
    bufp->fullIData(oldp+11,(0x33829b9cU),32);
    bufp->fullIData(oldp+12,(0U),32);
    bufp->fullBit(oldp+13,(vlSelf->ALU32_Test__DOT__testF2S1B1T2_expected_zero));
    bufp->fullBit(oldp+14,(vlSelf->ALU32_Test__DOT__testF2S1B1T2_expected_overflow));
    bufp->fullIData(oldp+15,(0xcc7d6464U),32);
    bufp->fullBit(oldp+16,(vlSelf->ALU32_Test__DOT__testF2S1B1T3_expected_zero));
    bufp->fullBit(oldp+17,(vlSelf->ALU32_Test__DOT__testF2S1B1T3_expected_overflow));
}

...
VL_INLINE_OPT void VALU32_Test___024root___ico_sequent__TOP__0(VALU32_Test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VALU32_Test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32_Test___024root___ico_sequent__TOP__0\n"); );
    // Body
...
void VALU32_Test___024root___eval_ico(VALU32_Test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VALU32_Test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32_Test___024root___eval_ico\n"); );
    // Body
...
void VALU32_Test___024root___eval_triggers__ico(VALU32_Test___024root* vlSelf);
#ifdef VL_DEBUG
...
void VALU32_Test___024root___eval(VALU32_Test___024root* vlSelf) {
    ...
    while (__VicoContinue) {
        __VicoContinue = 0U;
        VALU32_Test___024root___eval_triggers__ico(vlSelf);
        if (vlSelf->__VicoTriggered.any()) {
            __VicoContinue = 1U;
            if (VL_UNLIKELY((0x64U < vlSelf->__VicoIterCount))) {
#ifdef VL_DEBUG
                VALU32_Test___024root___dump_triggers__ico(vlSelf);
#endif
                VL_FATAL_MT("ALU32_Test.v", 1, "", "Input combinational region did not converge.");
            }
            vlSelf->__VicoIterCount = ((IData)(1U) 
                                       + vlSelf->__VicoIterCount);
            VALU32_Test___024root___eval_ico(vlSelf);
        }
    }
    __VnbaIterCount = 0U;
    __VnbaContinue = 1U;

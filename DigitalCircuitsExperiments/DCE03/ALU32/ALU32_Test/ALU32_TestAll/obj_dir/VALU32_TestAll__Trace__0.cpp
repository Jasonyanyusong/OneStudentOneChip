...
void VALU32_TestAll___024root__trace_chg_sub_0(VALU32_TestAll___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VALU32_TestAll___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32_TestAll___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VALU32_TestAll___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void VALU32_TestAll___024root__trace_chg_sub_0(VALU32_TestAll___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VALU32_TestAll__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32_TestAll___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+7,(vlSelf->ALU32_TestAll__DOT__b_withCin),32);
}

void VALU32_TestAll___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32_TestAll___024root__trace_cleanup\n"); );
    // Init
    VALU32_TestAll___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VALU32_TestAll___024root*>(voidSelf);
    VALU32_TestAll__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;

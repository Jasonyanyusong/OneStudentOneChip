...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("000000? ????? ????? 001 ????? 00100 11", slli   , I, printf("RV32I SLLI\n")    , R(rd) = (unsigned)src1 << imm & 0b111111);
  // INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli   , I, printf("RV32I SRLI\n")    , R(rd) = (unsigned)src1 >> imm & 0b11111);
  // INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, printf("RV32I SRAI\n")    , R(rd) = (signed)src1 >> BITS(imm, 5, 0));

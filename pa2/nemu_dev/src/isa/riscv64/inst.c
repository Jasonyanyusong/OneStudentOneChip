...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? ??? ????? 11011 11", jal    , J, rv32i_JAL(s, rd, src1, src2, imm));    // Good
  INSTPAT("??????? ????? ????? ??? ????? 11001 11", jalr   , I, rv32i_JALR(s, rd, src1, src2, imm));   // Good
  INSTPAT("??????? ????? ????? 000 ????? 11000 11", beq    , B, rv32i_BEQ(s, rd, src1, src2, imm));    // Good
  INSTPAT("??????? ????? ????? 001 ????? 11000 11", bne    , B, rv32i_BNE(s, rd, src1, src2, imm));    // Good
  INSTPAT("??????? ????? ????? 100 ????? 11000 11", blt    , B, rv32i_BLT(s, rd, src1, src2, imm));    // Good
  INSTPAT("??????? ????? ????? 101 ????? 11000 11", bge    , B, rv32i_BGE(s, rd, src1, src2, imm));    // Good
  INSTPAT("??????? ????? ????? 110 ????? 11000 11", bltu   , B, rv32i_BLTU(s, rd, src1, src2, imm));   // Good
  INSTPAT("??????? ????? ????? 111 ????? 11000 11", bgeu   , B, rv32i_BGEU(s, rd, src1, src2, imm));   // Good

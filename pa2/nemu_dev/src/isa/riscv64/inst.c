...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00000 11", lb     , I, assert(0));
  INSTPAT("??????? ????? ????? 001 ????? 00000 11", lh     , I, assert(0));
  INSTPAT("??????? ????? ????? 010 ????? 00000 11", lw     , I, assert(0));
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu    , I, assert(0));
  INSTPAT("??????? ????? ????? 101 ????? 00000 11", lhu    , I, assert(0));
  INSTPAT("??????? ????? ????? 000 ????? 01000 11", sb     , S, assert(0));
  INSTPAT("??????? ????? ????? 000 ????? 01000 11", sh     , S, assert(0));
  INSTPAT("??????? ????? ????? 000 ????? 01000 11", sw     , S, assert(0));
  INSTPAT("??????? ????? ????? 000 ????? 00100 11", addi   , I, R(rd) = src1 + imm);
  INSTPAT("??????? ????? ????? 010 ????? 00100 11", slti   , I, assert(0));
  INSTPAT("??????? ????? ????? 011 ????? 00100 11", sltiu  , I, assert(0));

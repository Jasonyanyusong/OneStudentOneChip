...
void Vmy_and___024root__trace_chg_sub_0(Vmy_and___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vmy_and___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmy_and___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vmy_and___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vmy_and___024root__trace_chg_sub_0(Vmy_and___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vmy_and__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmy_and___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vmy_and___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmy_and___024root__trace_cleanup\n"); );
    // Init
    Vmy_and___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vmy_and___024root*>(voidSelf);
    Vmy_and__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;

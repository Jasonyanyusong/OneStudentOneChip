echo "Yi Sheng Yi Xin Environment Configurator for Ubuntu Linux LTS 22.04 (Jammy)"
sudo apt-get update
...
echo "Install management tools for Beijing 101 Talent Academy"
...
echo "All Basic Tools for Yi Sheng Yi Xin is Installed on this workstation!"

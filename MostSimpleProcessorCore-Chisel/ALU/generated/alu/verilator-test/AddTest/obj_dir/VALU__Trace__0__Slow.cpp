...
VL_ATTR_COLD void VALU___024root__trace_init_sub__TOP__0(VALU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declQuad(c+3,"io_DataInA", false,-1, 63,0);
    tracep->declQuad(c+5,"io_DataInB", false,-1, 63,0);
    tracep->declBus(c+7,"io_OperateCode", false,-1, 3,0);
    tracep->declQuad(c+8,"io_ALUResult", false,-1, 63,0);
...
VL_ATTR_COLD void VALU___024root__trace_full_sub_0(VALU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullQData(oldp+3,(vlSelf->io_DataInA),64);
    bufp->fullQData(oldp+5,(vlSelf->io_DataInB),64);
    bufp->fullCData(oldp+7,(vlSelf->io_OperateCode),4);
    bufp->fullQData(oldp+8,(vlSelf->io_ALUResult),64);
}
